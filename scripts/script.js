...
const formEditCloseIcon = document.querySelector(".popup__close-icon");
const profileEditForm = document.querySelector("#form");
const profileNameElement = document.querySelector(".profile__name");
const profileJobElement = document.querySelector(".profile__job");
const profileNameInput = form.querySelector(".form__input-name");
const profileJobInput = form.querySelector(".form__input-job");
